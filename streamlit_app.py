...
st.write("## 🤢정신 똑디 차려🤢")
st.image(width=400,caption=”Image example: BMI”,'https://usefulguide.net/wp-content/uploads/2022/08/BMI-%EC%A7%80%EC%88%98%EC%97%90-%EB%94%B0%EB%A5%B8-%EC%B2%B4%ED%98%95.jpg')
